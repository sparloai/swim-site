...
function createOrUpdateCartItem(
  ...
  return {
    ...
    cost: {
      totalAmount: {
        amount: calculateItemCost(quantity, variant.price.amount),
  ...
  switch (action.type) {
    case 'UPDATE_ITEM': {
      ...
      if (updatedLines.length === 0) {
        return { ...currentCart, lines: [], totalQuantity: 0, cost: { ...currentCart.cost, totalAmount: { ...currentCart.cost.totalAmount, amount: '0' } } };
      }
